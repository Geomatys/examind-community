 ...
 */
public interface SensorProvider extends DataProvider {
     ...
     */
    String getNewSensorId() throws ConstellationStoreException;
     ...
     * @throws ConstellationStoreException
     */
    boolean writeSensor(String id, Object sensor) throws ConstellationStoreException;
