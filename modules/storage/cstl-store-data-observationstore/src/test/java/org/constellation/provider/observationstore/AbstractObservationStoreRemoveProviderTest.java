 ...
 * @author glegal
 */
public abstract class AbstractObservationStoreRemoveProviderTest extends SpringContextTest{
    ...
    protected final int NB_SENSOR          = 19; // include empty procedure
    protected final int NB_USED_SENSOR     = 17; // only 16 because 2 of the recorded procedure have no observation
