...
window.buildDataViewer = function () {
    return {
        ...
        createLayer : function(cstlUrlPrefix, dataId, layerName, filter, tiled){
            var params = {
                'DATA_ID': dataId,
                'VERSION':     '1.3.0',
                'SLD_VERSION': '1.1.0',
        ...
        createLayerWithStyle : function(cstlUrlPrefix, dataId, layerName, style, sldProvider, filter, tiled){
