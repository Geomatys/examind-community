...
<%@ page import="org.constellation.dto.AppProperty" %>
<%@ page import="org.constellation.dto.Application" %>
<%@ page import="org.constellation.dto.metadata.RootObj" %>
<%@ page import="org.constellation.dto.metadata.SuperBlockObj" %>
<%@ page import="org.constellation.dto.metadata.BlockObj" %>
<%@ page import="org.constellation.dto.metadata.FieldObj" %>
...
<%
    ...
    //2) get cstl url from config and if null then get from request
    String cstlUrl = Application.getProperty(AppProperty.CSTL_URL);
    if(cstlUrl == null) {
        cstlUrl = request.getRequestURL().toString();
    ...
    if(metadataId != null) {
        responseJson = sendRequest(cstlUrl+"/API/internal/metadata/"+metadataId+"/json");
    }
