...
angular.module('cstl-process-plan', ['cstl-restapi', 'cstl-services', 'ui.bootstrap.modal', 'examind-instance'])

    .controller('ModalPlanTaskController', function($scope, $modalInstance, Growl, textService, task, Examind){
                ...
                Examind.tasks.updateParamsTask($scope.task)
                    .then(function(response) {
                        ...
                        if ($scope.task.triggerType !== null) {
                            Examind.tasks.startScheduleParamsTask($scope.task.id)
                                .then(function (response) {
                            ...
                            Examind.tasks.stopScheduleParamsTask($scope.task.id)
                                .then(function (response) {
