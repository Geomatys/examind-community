...
angular.module('cstl-sensor-view', ['cstl-restapi', 'cstl-services', 'ui.bootstrap.modal'])
    ...
    .controller('SensorModalController', function($scope, $modalInstance, Examind, service, sensorId, Growl, $http, StompService) {
        ...
        $scope.initSensorView = function() {
            ...
            function(measures){
                ...
                $scope.measures = [];
                for (var i=0; i<measures.data.length; i++) {
                    var newMeasureId = measures.data[i];
                    var check = false;
                    if (oldMeasures) {
        ...
        $scope.initMap = function() {
            ...
            function(wkt) {
                ...
                var features;
                if(wkt.data) {
                    features = wktReader.readFeatures(wkt.data,
                        {
