...
public class OrganizationTemplate extends AbractContactTemplate {

    public OrganizationTemplate() {
        super("profile_contact_organization",
              "org/constellation/json/metadata/profile_contact_organization.json");
    }
