...
public class Query {
    ...
    * Build a SQL query with SELECT ,FROM, WHERE and ORDERBY clause.
    ...
    public List<Where> getAllWhere(final String group) {
        final List<Where> result = new ArrayList<>();
        for (Where s: getWhere()) {
            if (group != null && group.equals(s.getGroup())) {
                result.add(s);
            }
     ...
     *
     * @param where a SQL WHERE clause
     */
     ...
     *
     * @param orderby a SQL ORDERBY clause
     */
    ...
    public List<LeftJoin> getAllLeftJoin(final String group) {
        final List<LeftJoin> result = new ArrayList<>();
        for (LeftJoin s: getLeftJoin()) {
            if (group != null && group.equals(s.getGroup())) {
                result.add(s);
            }
     ...
     *
     * @param leftJoin a SQL LeftJoin clause
     */
    ...
    public String buildSQLQuery() {
        return buildSQLQuery(new HashMap<>());
    }
    /**
