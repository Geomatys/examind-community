...
public class MetadataLists implements Serializable {
    ...
    private List<String> spatialRepresentationCodes;
    ...
    public MetadataLists(MetadataLists m) {
        if (m != null) {
            ...
            this.progressCodes = m.progressCodes;
            this.spatialRepresentationCodes = m.spatialRepresentationCodes;
        }
    }
    ...
    public List<String> getSpatialRepresentationCodes() {
        return spatialRepresentationCodes;
    }

    public void setSpatialRepresentationCodes(List<String> spatialRepresentationCodes) {
        this.spatialRepresentationCodes = spatialRepresentationCodes;
    }
}
