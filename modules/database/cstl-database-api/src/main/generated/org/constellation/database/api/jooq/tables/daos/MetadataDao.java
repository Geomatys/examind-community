...
public class MetadataDao extends org.jooq.impl.DAOImpl<org.constellation.database.api.jooq.tables.records.MetadataRecord, org.constellation.database.api.jooq.tables.pojos.Metadata, java.lang.Integer> {
	 ...
	 */
	public java.util.List<org.constellation.database.api.jooq.tables.pojos.Metadata> fetchByProviderId(java.lang.Integer... values) {
		return fetch(org.constellation.database.api.jooq.tables.Metadata.METADATA.PROVIDER_ID, values);
	}

	/**
	 * Fetch records that have <code>map_context_id IN (values)</code>
	 */
	public java.util.List<org.constellation.database.api.jooq.tables.pojos.Metadata> fetchByMapContextId(java.lang.Integer... values) {
		return fetch(org.constellation.database.api.jooq.tables.Metadata.METADATA.MAP_CONTEXT_ID, values);
	}

	/**
	 * Fetch records that have <code>type IN (values)</code>
	 */
	public java.util.List<org.constellation.database.api.jooq.tables.pojos.Metadata> fetchByType(java.lang.String... values) {
		return fetch(org.constellation.database.api.jooq.tables.Metadata.METADATA.TYPE, values);
	}

	/**
	 * Fetch records that have <code>is_shared IN (values)</code>
	 */
	public java.util.List<org.constellation.database.api.jooq.tables.pojos.Metadata> fetchByIsShared(java.lang.Boolean... values) {
		return fetch(org.constellation.database.api.jooq.tables.Metadata.METADATA.IS_SHARED, values);
	}

	/**
	 * Fetch records that have <code>is_hidden IN (values)</code>
	 */
	public java.util.List<org.constellation.database.api.jooq.tables.pojos.Metadata> fetchByIsHidden(java.lang.Boolean... values) {
		return fetch(org.constellation.database.api.jooq.tables.Metadata.METADATA.IS_HIDDEN, values);
	}
}
