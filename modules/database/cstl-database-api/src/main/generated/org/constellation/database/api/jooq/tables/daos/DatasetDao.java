...
public class DatasetDao extends org.jooq.impl.DAOImpl<org.constellation.database.api.jooq.tables.records.DatasetRecord, org.constellation.database.api.jooq.tables.pojos.Dataset, java.lang.Integer> {
	 ...
	 */
	public java.util.List<org.constellation.database.api.jooq.tables.pojos.Dataset> fetchByType(java.lang.String... values) {
		return fetch(org.constellation.database.api.jooq.tables.Dataset.DATASET.TYPE, values);
	}
}
