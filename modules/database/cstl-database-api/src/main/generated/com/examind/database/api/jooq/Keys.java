...
public class Keys {
    ...
    public static final ForeignKey<SceneRecord, LayerRecord> SCENE__SCENE_DATA_FK = Internal.createForeignKey(Scene.SCENE, DSL.name("scene_data_fk"), new TableField[] { Scene.SCENE.LAYER_ID }, Keys.LAYER_PK, new TableField[] { Layer.LAYER.ID }, true);
    public static final ForeignKey<SceneRecord, DataRecord> SCENE__SCENE_LAYER_FK = Internal.createForeignKey(Scene.SCENE, DSL.name("scene_layer_fk"), new TableField[] { Scene.SCENE.DATA_ID }, Keys.DATA_PK, new TableField[] { Data.DATA.ID }, true);
