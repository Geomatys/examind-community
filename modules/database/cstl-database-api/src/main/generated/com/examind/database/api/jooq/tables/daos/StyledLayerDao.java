...
public class StyledLayerDao extends DAOImpl<StyledLayerRecord, com.examind.database.api.jooq.tables.pojos.StyledLayer, Record2<Integer, Integer>> {

    /**
     * Create a new StyledLayerDao without any configuration
     */
    public StyledLayerDao() {
        super(StyledLayer.STYLED_LAYER, com.examind.database.api.jooq.tables.pojos.StyledLayer.class);
    }
    ...
    public StyledLayerDao(Configuration configuration) {
        super(StyledLayer.STYLED_LAYER, com.examind.database.api.jooq.tables.pojos.StyledLayer.class, configuration);
    }

    @Override
    public Record2<Integer, Integer> getId(com.examind.database.api.jooq.tables.pojos.StyledLayer object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.StyledLayer> fetchRangeOfStyle(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.StyledLayer> fetchByStyle(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.StyledLayer> fetchRangeOfLayer(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.StyledLayer> fetchByLayer(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.StyledLayer> fetchRangeOfIsDefault(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.StyledLayer> fetchByIsDefault(Boolean... values) {
