...
public class SensoredDataDao extends DAOImpl<SensoredDataRecord, com.examind.database.api.jooq.tables.pojos.SensoredData, Record2<Integer, Integer>> {

    /**
     * Create a new SensoredDataDao without any configuration
     */
    public SensoredDataDao() {
        super(SensoredData.SENSORED_DATA, com.examind.database.api.jooq.tables.pojos.SensoredData.class);
    }
    ...
    public SensoredDataDao(Configuration configuration) {
        super(SensoredData.SENSORED_DATA, com.examind.database.api.jooq.tables.pojos.SensoredData.class, configuration);
    }

    @Override
    public Record2<Integer, Integer> getId(com.examind.database.api.jooq.tables.pojos.SensoredData object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensoredData> fetchRangeOfSensor(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensoredData> fetchBySensor(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensoredData> fetchRangeOfData(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensoredData> fetchByData(Integer... values) {
