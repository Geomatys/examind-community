...
public class SensorXSosDao extends DAOImpl<SensorXSosRecord, com.examind.database.api.jooq.tables.pojos.SensorXSos, Record2<Integer, Integer>> {

    /**
     * Create a new SensorXSosDao without any configuration
     */
    public SensorXSosDao() {
        super(SensorXSos.SENSOR_X_SOS, com.examind.database.api.jooq.tables.pojos.SensorXSos.class);
    }
    ...
    public SensorXSosDao(Configuration configuration) {
        super(SensorXSos.SENSOR_X_SOS, com.examind.database.api.jooq.tables.pojos.SensorXSos.class, configuration);
    }

    @Override
    public Record2<Integer, Integer> getId(com.examind.database.api.jooq.tables.pojos.SensorXSos object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensorXSos> fetchRangeOfSensorId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensorXSos> fetchBySensorId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensorXSos> fetchRangeOfSosId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.SensorXSos> fetchBySosId(Integer... values) {
