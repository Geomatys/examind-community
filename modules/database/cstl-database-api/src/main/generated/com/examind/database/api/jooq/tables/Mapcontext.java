...
public class Mapcontext extends TableImpl<MapcontextRecord> {
    ...
    private Mapcontext(Name alias, Table<MapcontextRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> Mapcontext(Table<O> path, ForeignKey<O, MapcontextRecord> childPath, InverseForeignKey<O, MapcontextRecord> parentPath) {
        super(path, childPath, parentPath, MAPCONTEXT);
    }

    /**
     * A subtype implementing {@link Path} for simplified path-based joins.
     */
    public static class MapcontextPath extends Mapcontext implements Path<MapcontextRecord> {

        private static final long serialVersionUID = 1L;
        public <O extends Record> MapcontextPath(Table<O> path, ForeignKey<O, MapcontextRecord> childPath, InverseForeignKey<O, MapcontextRecord> parentPath) {
            super(path, childPath, parentPath);
        }
        private MapcontextPath(Name alias, Table<MapcontextRecord> aliased) {
            super(alias, aliased);
        }

        @Override
        public MapcontextPath as(String alias) {
            return new MapcontextPath(DSL.name(alias), this);
        }

        @Override
        public MapcontextPath as(Name alias) {
            return new MapcontextPath(alias, this);
        }

        @Override
        public MapcontextPath as(Table<?> alias) {
            return new MapcontextPath(alias.getQualifiedName(), this);
        }
    }
    ...
    public CstlUserPath cstlUser() {
        if (_cstlUser == null)
            _cstlUser = new CstlUserPath(this, Keys.MAPCONTEXT__MAPCONTEXT_OWNER_FK, null);
    ...
    public MetadataPath metadata() {
        if (_metadata == null)
            _metadata = new MetadataPath(this, null, Keys.METADATA__MAP_CONTEXT_ID_FK.getInverseKey());
    ...
    public MapcontextStyledLayerPath mapcontextStyledLayer() {
        if (_mapcontextStyledLayer == null)
            _mapcontextStyledLayer = new MapcontextStyledLayerPath(this, null, Keys.MAPCONTEXT_STYLED_LAYER__MAPCONTEXT_STYLED_LAYER_MAPCONTEXT_ID_FK.getInverseKey());
     ...
     */
    @Override
    public Mapcontext where(Condition condition) {
        return new Mapcontext(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Mapcontext where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Mapcontext where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Mapcontext where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Mapcontext where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Mapcontext where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Mapcontext where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Mapcontext where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Mapcontext whereExists(Select<?> select) {
     ...
     */
    @Override
    public Mapcontext whereNotExists(Select<?> select) {
