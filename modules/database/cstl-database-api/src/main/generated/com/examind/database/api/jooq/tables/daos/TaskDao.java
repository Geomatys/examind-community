...
public class TaskDao extends DAOImpl<TaskRecord, com.examind.database.api.jooq.tables.pojos.Task, String> {

    /**
     * Create a new TaskDao without any configuration
     */
    public TaskDao() {
        super(Task.TASK, com.examind.database.api.jooq.tables.pojos.Task.class);
    }
    ...
    public TaskDao(Configuration configuration) {
        super(Task.TASK, com.examind.database.api.jooq.tables.pojos.Task.class, configuration);
    }

    @Override
    public String getId(com.examind.database.api.jooq.tables.pojos.Task object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfIdentifier(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByIdentifier(String... values) {
     ...
     */
    public com.examind.database.api.jooq.tables.pojos.Task fetchOneByIdentifier(String value) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfState(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByState(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByType(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfDateStart(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByDateStart(Long... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfDateEnd(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByDateEnd(Long... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfOwner(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByOwner(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfMessage(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByMessage(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfTaskParameterId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByTaskParameterId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfProgress(Double lowerInclusive, Double upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByProgress(Double... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchRangeOfTaskOutput(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Task> fetchByTaskOutput(String... values) {
