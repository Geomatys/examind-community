...
public class MapcontextStyledLayerDao extends DAOImpl<MapcontextStyledLayerRecord, com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer, Integer> {

    /**
     * Create a new MapcontextStyledLayerDao without any configuration
     */
    public MapcontextStyledLayerDao() {
        super(MapcontextStyledLayer.MAPCONTEXT_STYLED_LAYER, com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer.class);
    }
    ...
    public MapcontextStyledLayerDao(Configuration configuration) {
        super(MapcontextStyledLayer.MAPCONTEXT_STYLED_LAYER, com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer.class, configuration);
    }

    @Override
    public Integer getId(com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer object) {
        return object.getId();
    }
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchById(Integer... values) {
     ...
     */
    public com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer fetchOneById(Integer value) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfMapcontextId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByMapcontextId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfLayerId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByLayerId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfStyleId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByStyleId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfLayerOrder(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByLayerOrder(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfLayerOpacity(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByLayerOpacity(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfLayerVisible(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByLayerVisible(Boolean... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfExternalLayer(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByExternalLayer(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfExternalLayerExtent(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByExternalLayerExtent(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfExternalServiceUrl(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByExternalServiceUrl(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfExternalServiceVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByExternalServiceVersion(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfExternalStyle(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByExternalStyle(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfIswms(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByIswms(Boolean... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchRangeOfDataId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.MapcontextStyledLayer> fetchByDataId(Integer... values) {
