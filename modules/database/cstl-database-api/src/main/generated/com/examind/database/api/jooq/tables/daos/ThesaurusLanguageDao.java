...
public class ThesaurusLanguageDao extends DAOImpl<ThesaurusLanguageRecord, com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage, Record2<Integer, String>> {

    /**
     * Create a new ThesaurusLanguageDao without any configuration
     */
    public ThesaurusLanguageDao() {
        super(ThesaurusLanguage.THESAURUS_LANGUAGE, com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage.class);
    }
    ...
    public ThesaurusLanguageDao(Configuration configuration) {
        super(ThesaurusLanguage.THESAURUS_LANGUAGE, com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage.class, configuration);
    }

    @Override
    public Record2<Integer, String> getId(com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage> fetchRangeOfThesaurusId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage> fetchByThesaurusId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage> fetchRangeOfLanguage(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.ThesaurusLanguage> fetchByLanguage(String... values) {
