...
public class DatasourcePathStoreDao extends DAOImpl<DatasourcePathStoreRecord, com.examind.database.api.jooq.tables.pojos.DatasourcePathStore, Record4<Integer, String, String, String>> {

    /**
     * Create a new DatasourcePathStoreDao without any configuration
     */
    public DatasourcePathStoreDao() {
        super(DatasourcePathStore.DATASOURCE_PATH_STORE, com.examind.database.api.jooq.tables.pojos.DatasourcePathStore.class);
    }
    ...
    public DatasourcePathStoreDao(Configuration configuration) {
        super(DatasourcePathStore.DATASOURCE_PATH_STORE, com.examind.database.api.jooq.tables.pojos.DatasourcePathStore.class, configuration);
    }

    @Override
    public Record4<Integer, String, String, String> getId(com.examind.database.api.jooq.tables.pojos.DatasourcePathStore object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchRangeOfDatasourceId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchByDatasourceId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchRangeOfPath(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchByPath(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchRangeOfStore(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchByStore(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePathStore> fetchByType(String... values) {
