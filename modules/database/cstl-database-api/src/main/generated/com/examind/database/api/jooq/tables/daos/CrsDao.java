...
public class CrsDao extends DAOImpl<CrsRecord, com.examind.database.api.jooq.tables.pojos.Crs, Record2<Integer, String>> {

    /**
     * Create a new CrsDao without any configuration
     */
    public CrsDao() {
        super(Crs.CRS, com.examind.database.api.jooq.tables.pojos.Crs.class);
    }
    ...
    public CrsDao(Configuration configuration) {
        super(Crs.CRS, com.examind.database.api.jooq.tables.pojos.Crs.class, configuration);
    }

    @Override
    public Record2<Integer, String> getId(com.examind.database.api.jooq.tables.pojos.Crs object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Crs> fetchRangeOfDataid(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Crs> fetchByDataid(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Crs> fetchRangeOfCrscode(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.Crs> fetchByCrscode(String... values) {
