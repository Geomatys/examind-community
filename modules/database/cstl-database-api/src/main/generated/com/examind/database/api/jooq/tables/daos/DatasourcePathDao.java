...
public class DatasourcePathDao extends DAOImpl<DatasourcePathRecord, com.examind.database.api.jooq.tables.pojos.DatasourcePath, Record2<Integer, String>> {

    /**
     * Create a new DatasourcePathDao without any configuration
     */
    public DatasourcePathDao() {
        super(DatasourcePath.DATASOURCE_PATH, com.examind.database.api.jooq.tables.pojos.DatasourcePath.class);
    }
    ...
    public DatasourcePathDao(Configuration configuration) {
        super(DatasourcePath.DATASOURCE_PATH, com.examind.database.api.jooq.tables.pojos.DatasourcePath.class, configuration);
    }

    @Override
    public Record2<Integer, String> getId(com.examind.database.api.jooq.tables.pojos.DatasourcePath object) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchRangeOfDatasourceId(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchByDatasourceId(Integer... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchRangeOfPath(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchByPath(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchByName(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchRangeOfFolder(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchByFolder(Boolean... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchRangeOfParentPath(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchByParentPath(String... values) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchRangeOfSize(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.examind.database.api.jooq.tables.pojos.DatasourcePath> fetchBySize(Integer... values) {
