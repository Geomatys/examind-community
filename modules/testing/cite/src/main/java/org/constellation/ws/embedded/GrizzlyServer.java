...
public final class GrizzlyServer {
    ...
    public synchronized void initServer() throws Exception {
        ...
        //SHAPEFILE
        final ProviderFactory featfactory = DataProviders.getInstance().getFactory("data-store");
        ...
        getOrCreateValue(shpconfig, "path").setValue(URI.create("file:" + outputDir.getAbsolutePath() + "/org/constellation/ws/embedded/wms111/shapefiles"));
        ...
        final ProviderFactory factory = DataProviders.getInstance().getFactory("data-store");
        ...
        pgconfig.parameter("path").setValue(URI.create("file:"+outputDir.getAbsolutePath() + "/org/constellation/ws/embedded/wfs110/primitive"));
        ...
        pgconfig.parameter("identifier").setValue("gml");
        pgconfig.parameter("path").setValue(URI.create("file:"+outputDir.getAbsolutePath() + "/org/constellation/ws/embedded/wfs110/entity"));
        pgconfig.parameter("sparse").setValue(Boolean.TRUE);
        pgconfig.parameter("xsd").setValue("file:"+outputDir.getAbsolutePath() + "/org/constellation/ws/embedded/wfs110/cite-gmlsf0.xsd");
        ...
        pgconfig = getOrCreateGroup(choice, "GMLParameters");
        pgconfig.parameter("identifier").setValue("gml");
        pgconfig.parameter("path").setValue(URI.create("file:"+outputDir.getAbsolutePath() + "/org/constellation/ws/embedded/wfs110/aggregate"));
        pgconfig.parameter("sparse").setValue(Boolean.TRUE);
        pgconfig.parameter("xsd").setValue("file:"+outputDir.getAbsolutePath() + "/org/constellation/ws/embedded/wfs110/cite-gmlsf0.xsd");
        ...
        final ProviderFactory covFilefactory = DataProviders.getInstance().getFactory("data-store");
        ...
        providerBusiness.storeProvider("postgridSrc", null, ProviderType.LAYER, "data-store", sourceCF);
        ...
        wfsConfig.getCustomParameters().put("transactional", "true");
    ...
    private static void deleteDataDirectory() throws IOException {
        ...
        if (outputDir.exists()) {
            if (outputDir.canWrite()) {
                if (!IOUtilities.deleteRecursively(outputDir.toPath())) {
