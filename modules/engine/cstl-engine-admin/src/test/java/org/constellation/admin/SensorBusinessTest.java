...
public class SensorBusinessTest {
    ...
    public void createTest() throws Exception {
        ...
        Integer sid1 = sensorBusiness.create("sensor-1", "System", null, s1Meta, System.currentTimeMillis(), null);
        ...
        Integer sid2 = sensorBusiness.create("sensor-2", "Component", "sensor-1", s2Meta, System.currentTimeMillis(), pid);
