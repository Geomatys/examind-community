...
public abstract class StartServiceTest extends ServiceProcessTest {
    ...
    public void testStart() throws NoSuchIdentifierException, ProcessException {
        ...
        try {
            ...
            final ProcessDescriptor desc = ProcessFinder.getProcessDescriptor(ExamindProcessFactory.NAME, StartServiceDescriptor.NAME);
            ...
            assertTrue(engine.serviceInstanceExist(serviceName, "startInstance1"));
