...
public class CsvObservationStoreFactory extends FileParsingObservationStoreFactory {
    ...
    public static final ParameterDescriptorGroup PARAMETERS_DESCRIPTOR
            = PARAM_BUILDER.addName(NAME).addName("ObservationCsvFileParameters").createGroup(IDENTIFIER, NAMESPACE, PATH, SEPARATOR,
                    ...
                    PROCEDURE_COLUMN, PROCEDURE_NAME_COLUMN, PROCEDURE_DESC_COLUMN, PROCEDURE_REGEX, PROCEDURE_DESC, PROCEDURE_NAME, PROCEDURE_PROPERTIES_MAP_COLUMN, PROCEDURE_PROPERTIES_COLUMN, Z_COLUMN, UOM_REGEX, UOM_ID, CHARQUOTE, OBS_PROP_REGEX, FILE_MIME_TYPE, NO_HEADER, DIRECT_COLUMN_INDEX, QUALITY_COLUMN,
