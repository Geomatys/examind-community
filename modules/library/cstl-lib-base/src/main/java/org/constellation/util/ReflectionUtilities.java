...
public final class ReflectionUtilities {
     ...
     * @param propertyName   The attribute name.
     * @param classe         The attribute type.
     * @param parameterClass The class which owe this attribute
     *
     * @return a setter to this attribute or {@code null}.
     */
     ...
     *
     * @param propertyName The attribute name.
     * @param paramClass   The attribute type.
     * @param rootClass    The class which owe this attribute
     *
     * @return a setter to this attribute or {@code null}.
     */
        ...
        if (object != null) {
            ...
            if (getter != null) {
                ...
                if (getter != null) {
                    ...
                    if (object instanceof ISOMetadata && "uuid".equals(attributeName)) {
                        result = ((ISOMetadata)object).getIdentifierMap().getSpecialized(IdentifierSpace.UUID);
                    } else {
