...
public enum CstlMetadataTemplate {
    ...
    /**
     * Determines the {@linkplain CstlMetadataTemplate metadata template} for a given
     * {@linkplain DefaultMetadata metadata}.
     *
     * @param metadata The metadata for which to retrieve its template.
     * @return A {@linkplain CstlMetadataTemplate template}, or {@code null} if none found
     *         for this metadata.
     */
