...
public interface ICSWConfigurer {
    ...
    AcknowlegementType importRecords(final String id, final Path f, final String fileName) throws ConfigurationException ;

    AcknowlegementType importRecord(final String id, final Node n) throws ConfigurationException;

    AcknowlegementType removeRecords(final String identifier) throws ConfigurationException;
