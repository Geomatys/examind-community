...
public final class CSWQueryable {
    ...
    static {
        ...
        ISO_QUERYABLE.put("Subject", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Title", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Abstract", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Format", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Identifier", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Modified", new PathType(Date.class, paths));
        ...
        ISO_QUERYABLE.put("Type", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("WestBoundLongitude",     new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("EastBoundLongitude",     new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("NorthBoundLatitude",     new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("SouthBoundLatitude",     new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("Authority",     new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("ID",     new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Version",     new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("AlternateTitle",   new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("RevisionDate",  new PathType(Date.class, paths));
        ...
        ISO_QUERYABLE.put("CreationDate",  new PathType(Date.class, paths));
        ...
        ISO_QUERYABLE.put("PublicationDate",  new PathType(Date.class, paths));
        ...
        ISO_QUERYABLE.put("OrganisationName", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Language", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("ResourceIdentifier", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("ParentIdentifier", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("KeywordType", new PathType(String.class, paths));

        paths = new ArrayList<>();
        paths.add("/gmd:MD_Metadata/gmd:identificationInfo/*/gmd:topicCategory/gmd:MD_TopicCategoryCode");
        paths.add("/gmi:MI_Metadata/gmd:identificationInfo/*/gmd:topicCategory/gmd:MD_TopicCategoryCode");
        ISO_QUERYABLE.put("TopicCategory", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("ResourceLanguage", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("GeographicDescriptionCode", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Denominator", new PathType(Integer.class, paths));
        ...
        ISO_QUERYABLE.put("DistanceValue", new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("DistanceUOM", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("TempExtent_begin", new PathType(Date.class, paths));
        ...
        paths.add("/gmi:MI_Metadata/gmd:identificationInfo/*/gmd:extent/gmd:EX_Extent/gmd:temporalElement/gmd:EX_TemporalExtent/gmd:extent/gml:TimeInstant/gml:position");
        ISO_QUERYABLE.put("TempExtent_end", new PathType(Date.class, paths));
        ...
        ISO_QUERYABLE.put("CloudCover", new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("IlluminationElevation", new PathType(Double.class, paths));
        ...
        ISO_QUERYABLE.put("ProcessingLevel", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("ServiceType", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("CouplingType", new PathType(String.class, paths));

        //TODO  the following element are described in Service part of ISO 19139 not yet used.
        paths = new ArrayList<>();
        ISO_QUERYABLE.put("ServiceTypeVersion",  new PathType(String.class, paths));
        ISO_QUERYABLE.put("OperatesOn",           new PathType(String.class, paths));
        ISO_QUERYABLE.put("OperatesOnIdentifier", new PathType(String.class, paths));
        ISO_QUERYABLE.put("OperatesOnWithOpName", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Platform", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Instrument", new PathType(String.class, paths));
        ...
        ISO_QUERYABLE.put("Operation", new PathType(String.class, paths));
    }
    ...
    static {
        ...
        DUBLIN_CORE_QUERYABLE.put("publisher", new PathType(String.class, paths));
        ...
        DUBLIN_CORE_QUERYABLE.put("contributor", new PathType(String.class, paths));
        ...
        DUBLIN_CORE_QUERYABLE.put("source", new PathType(String.class, paths));
        ...
        DUBLIN_CORE_QUERYABLE.put("language", new PathType(String.class, paths));
        ...
        DUBLIN_CORE_QUERYABLE.put("relation", new PathType(String.class, paths));
        ...
        DUBLIN_CORE_QUERYABLE.put("rights", new PathType(String.class, paths));
    ...
    static {
        ...
        EBRIM_QUERYABLE.put("name", new PathType(String.class, paths));

        //TODO verify codelist=originator
        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("creator", new PathType(String.class, paths));
        ...
        EBRIM_QUERYABLE.put("description", new PathType(String.class, paths));
        EBRIM_QUERYABLE.put("subject", new PathType(String.class, paths));
        ...
        EBRIM_QUERYABLE.put("abstract", new PathType(String.class, paths));

        //TODO verify codelist=publisher
        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("publisher", new PathType(String.class, paths));

        //TODO verify codelist=contributor
        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("contributor", new PathType(String.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("date", new PathType(String.class, paths));

        paths = new ArrayList<>();
        paths.add("/eb3:RegistryObject/@objectType");
        paths.add("/eb3:RegistryPackage/@objectType");
        EBRIM_QUERYABLE.put("type", new PathType(String.class, paths));

        paths = new ArrayList<>();
        paths.add("/eb3:ExtrinsicObject/@mimeType");
        EBRIM_QUERYABLE.put("format", new PathType(String.class, paths));

        paths = new ArrayList<>();
        paths.add("/eb3:RegistryObject/@id");
        paths.add("/eb3:RegistryPackage/@id");
        EBRIM_QUERYABLE.put("identifier", new PathType(String.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("source", new PathType(String.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("language", new PathType(String.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("relation", new PathType(String.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("rigths", new PathType(String.class, paths));

        /*
         * Bounding box
         */
        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("WestBoundLongitude",     new PathType(Double.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("EastBoundLongitude",     new PathType(Double.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("NorthBoundLatitude",     new PathType(Double.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("SouthBoundLatitude",     new PathType(Double.class, paths));

        paths = new ArrayList<>();
        EBRIM_QUERYABLE.put("CRS",     new PathType(String.class, paths));
    }
    ...
    static {
        ...
        INSPIRE_QUERYABLE.put("Degree", new PathType(Boolean.class, paths));

        paths = new ArrayList<>();
        paths.add("/gmd:MD_Metadata/gmd:identificationInfo/*/gmd:resourceConstraints/*/gmd:accessConstraints/gmd:MD_RestrictionCode");
        paths.add("/gmi:MI_Metadata/gmd:identificationInfo/*/gmd:resourceConstraints/*/gmd:accessConstraints/gmd:MD_RestrictionCode");
        INSPIRE_QUERYABLE.put("AccessConstraints", new PathType(String.class, paths));
        ...
        INSPIRE_QUERYABLE.put("OtherConstraints", new PathType(String.class, paths));
        ...
        INSPIRE_QUERYABLE.put("Classification", new PathType(String.class, paths));
        ...
        INSPIRE_QUERYABLE.put("ConditionApplyingToAccessAndUse", new PathType(String.class, paths));
        ...
        paths.add("/gmi:MI_Metadata/gmd:contact/gmd:CI_ResponsibleParty/gmd:organisationName/gco:CharacterString");
        paths.add("/gmi:MI_Metadata/gmd:contact/gmd:CI_ResponsibleParty/gmd:organisationName/gmx:Anchor");
        INSPIRE_QUERYABLE.put("MetadataPointOfContact", new PathType(String.class, paths));
        ...
        INSPIRE_QUERYABLE.put("Lineage", new PathType(String.class, paths));
        ...
        INSPIRE_QUERYABLE.put("SpecificationTitle", new PathType(String.class, paths));
        ...
        INSPIRE_QUERYABLE.put("SpecificationDate", new PathType(Date.class, paths));
        ...
        INSPIRE_QUERYABLE.put("SpecificationDateType", new PathType(String.class, paths));
    }
}
