...
public class StopAnalyzerTest extends AbstractAnalyzerTest {
    ...
    private static Path configDirectory = Paths.get("StopAnalyzerTest");
    ...
    public void setUpClass() throws Exception {
        if (!configured) {
            ...
            GenericIndexer indexer = new GenericIndexer(object, null, configDirectory, "", new StopAnalyzer(), Level.FINER, true);
            indexer.destroy();
