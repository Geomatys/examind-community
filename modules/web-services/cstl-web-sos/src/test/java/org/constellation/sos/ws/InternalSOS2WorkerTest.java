    ...
    public void setUp() {
        try {
            ...
            if (!initialized) {
                ...
                sml = unmarshallSensorResource("org/constellation/xml/sml/urnµogcµobjectµsensorµGEOMµ3.xml", sensorBusiness);
                sensorBusiness.create("urn:ogc:object:sensor:GEOM:3", "GEOM 3", "GEOM 3","component", null, null, sml, Long.MIN_VALUE, provider);
