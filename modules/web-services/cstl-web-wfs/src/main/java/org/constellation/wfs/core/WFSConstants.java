...
public final class WFSConstants {
    ...
    static {
        ...
        csqParameters.add(WFSXmlFactory.buildDomain("2.0.0", "language",   Arrays.asList("urn:ogc:def:queryLanguage:OGC-WFS::WFS_QueryExpression",
    ...
    static {
        ...
        final PropertyIsEqualToType pis = new PropertyIsEqualToType(new LiteralType("${id}"), AttributeConvention.IDENTIFIER_PROPERTY.toString(), true);
