...
public class WMTSService extends OGCWebService<WMTSWorker>{
    ...
    public Capabilities getCapabilities(@WebParam(name = "GetCapabilities", targetNamespace="http://www.opengis.net/wmts/1.0.0") GetCapabilities requestCapabilities)
                                                                                     throws SOAPServiceException
    {
        try {
    ...
    public String getFeatureInfo(@WebParam(name = "GetFeatureInfo", targetNamespace="http://www.opengis.net/wmts/1.0.0") GetFeatureInfo requestFeatureInfo)
                                                                           throws SOAPServiceException
    {
        try {
    ...
    public BinaryPayload getTile(@WebParam(name = "GetTile", targetNamespace="http://www.opengis.net/wmts/1.0.0") GetTile requestTile)
                                                      throws SOAPServiceException
    {
