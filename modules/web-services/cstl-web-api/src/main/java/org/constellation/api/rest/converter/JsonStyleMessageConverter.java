 ...
 */
public class JsonStyleMessageConverter implements HttpMessageConverter<Style> {
    ...
    @Override
    public Style read(Class<? extends Style> clazz, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ObjectMapper mapper = getMapper();
        return mapper.readValue(inputMessage.getBody(), Style.class);
    }

    @Override
    public void write(Style t, MediaType contentType, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ObjectMapper mapper = getMapper();
