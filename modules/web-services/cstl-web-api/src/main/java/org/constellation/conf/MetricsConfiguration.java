...
//    private JavaMailSenderImpl javaMailSender;
    ...
    @PostConstruct
    public void init() {
        LOGGER.finer("Registring JVM gauges");
        ...
        LOGGER.finer("Initializing Metrics healthchecks");
    ...
    public void configureReporters(MetricRegistry metricRegistry) {
        ...
        if (env.acceptsProfiles("prod")) {
            ...
            if (graphiteHost != null) {
                ...
                LOGGER.warning("Graphite server is not configured, unable to send any data to Graphite");
            }
        }
    }
}
