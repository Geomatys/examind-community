...
public class CSWService extends OGCWebService<CSWworker>{
    ...
    public CSWService() {
      ...
      LOGGER.log(Level.INFO, "CSW SOAP service running ({0} instances)", getWorkerMapSize());
    }
    ...
    public Capabilities getCapabilities(@WebParam(name = "GetCapabilities", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") GetCapabilitiesType requestCapabilities) throws SOAPServiceException  {
        try {
    ...
    public GetDomainResponseType getDomain(@WebParam(name = "GetDomain", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") GetDomainType requestGetDomain) throws SOAPServiceException  {
        try {
    ...
    public GetRecordByIdResponseType getRecordById(@WebParam(name = "GetRecordById", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") GetRecordByIdType requestRecordById) throws SOAPServiceException {
        try {
    ...
    public Object getRecords(@WebParam(name = "GetRecords", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") GetRecordsType requestRecords) throws SOAPServiceException {
        try {
    ...
    public DescribeRecordResponseType describeRecord(@WebParam(name = "DescribeRecord", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") DescribeRecordType requestDescribeRecord) throws SOAPServiceException {
        try {
    ...
    public HarvestResponseType harvest(@WebParam(name = "Harvest", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") HarvestType requestHarvest) throws SOAPServiceException {
        try {
    ...
    public TransactionResponseType transaction(@WebParam(name = "Transaction", targetNamespace="http://www.opengis.net/cat/csw/2.0.2") TransactionType requestTransaction) throws SOAPServiceException {
        try {
