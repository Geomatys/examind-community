...
public class DefaultCatalogueHarvester extends CatalogueHarvester {
     ...
     */
    private static final QName RECORD_QNAME = new QName(LegacyNamespaces.CSW, "Record");

    /**
     * a QName for gmd:Dataset type
     */
    private static final QName DATASET_QNAME = new QName(LegacyNamespaces.GMD, "Dataset");
     ...
     *
     * @param store a writer to the metadata datasource.
     */
    public DefaultCatalogueHarvester(final MetadataStore store) {
        super(store);
        initializeRequest();
    }
    ...
    private void initializeRequest() {
        ...
        fullGetRecordsRequestv202 = new GetRecordsType(CSW, CSW_202_VERSION, ResultType.RESULTS, null, MimeType.APPLICATION_XML, LegacyNamespaces.CSW, 1, 20, query, null);
    ...
    private GetRecordsRequest analyseCapabilitiesDocument(CapabilitiesBaseType capa, GetRecordsRequest request) {
        ...
        if (getRecordOp != null) {
            ...
            if (outputDomain != null) {
                ...
                bestDistantOuputSchema = LegacyNamespaces.CSW;
            }
    ...
    private String getBestOutputSchema(List<String> availableOutputSchema) {
        ...
        } else if (availableOutputSchema.contains(LegacyNamespaces.GMD)) {
        ...
        } else if (availableOutputSchema.contains(LegacyNamespaces.CSW)) {
            return LegacyNamespaces.CSW;
