 ...
 * @see https://docs.ogc.org/DRAFTS/21-038r1.html#rc_table-data_ubjson
 * @see https://docs.ogc.org/DRAFTS/21-038r1.html#conf_data-ubjson
 *
 * @author Johann Sorel (Geomatys)
 */
public class Conformance11_DggsUBJsonDataEncodingTest extends DGGSAbstractTest {
    ...
    /**
     * @see https://docs.ogc.org/DRAFTS/21-038r1.html#conf_data-ubjson_content
     * @see https://docs.ogc.org/DRAFTS/21-038r1.html#_req_data-ubjson_content
     */
    @Test
    public void requirement25() throws Exception {
        initLayerList();
        ...
        { //check getting the data at a single depth
            final DggrsData dto = sendRequestAndParse(
                        ...
                        MediaTypes.DATA_UBJSON, DggrsData.class);
            assertEquals(
                """
                 {
