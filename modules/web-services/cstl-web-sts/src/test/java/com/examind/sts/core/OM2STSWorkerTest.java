...
public class OM2STSWorkerTest extends SpringContextTest {
    ...
    public void getFeatureOfInterestByIdTest() throws Exception {
        ...
        Assert.assertEquals(100, result.getObservations().size());
        ...
        */
        ...
        Assert.assertEquals(100, obsResult.getValue().size());
    ...
    public void getObservationsDataStreamDataArrayTest() throws Exception {
        ...
        expResult.setComponents(Arrays.asList("id", "phenomenonTime", "resultTime", "result", "resultQuality"));
        List<Object> array = new ArrayList<>();
        Date d = ISO_8601_3_FORMATTER.parse("2007-05-01T10:59:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-1", d, d, 6.56, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-2", d, d, 6.56, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-3", d, d, 6.56, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-4", d, d, 6.56, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-5", d, d, 6.56, new ArrayList<>()));
        ...
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-1", d, d, 2.5, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2009-12-01T13:00:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-2", d, d, 5.9, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2009-12-11T13:01:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-3", d, d, 8.9, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2009-12-15T13:02:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-4", d, d, 7.8, new ArrayList<>()));
        d = ISO_8601_3_FORMATTER.parse("2012-12-21T23:00:00.0");
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-5", d, d, 9.9, new ArrayList<>()));
        expResult.setDataArray(array);
    ...
    public void getObservationsDataStreamDataArrayDecimTest() throws Exception {
        ...
        expResult.setComponents(Arrays.asList("id", "phenomenonTime", "resultTime", "result", "resultQuality"));
        List<Object> array = new ArrayList<>();
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-0", ISO_8601_3_FORMATTER.parse("2007-05-01T10:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T10:59:00.0"), 6.56, new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-1", ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0"), 6.56, new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-2", ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0"), 6.56, new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-3", ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0"), 6.56, new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-4", ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0"), 6.56, new ArrayList()));
        expResult.setDataArray(array);
    ...
    public void getObservationsMultiDataStreamDataArrayTest() throws Exception {
        ...
        expResult.setComponents(Arrays.asList("id", "phenomenonTime", "resultTime", "result", "resultQuality"));
        List<Object> array = new ArrayList<>();
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:801-1", ISO_8601_3_FORMATTER.parse("2007-05-01T10:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T10:59:00.0"), new ArrayList(Arrays.asList(6.56d,12.0d)), new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:801-3", ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0"), new ArrayList(Arrays.asList(6.56d,13.0d)), new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:801-5", ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0"), new ArrayList(Arrays.asList(6.56d,14.0d)), new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:801-7", ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0"), new ArrayList(Arrays.asList(6.56d,15.0d)), new ArrayList()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:801-9", ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0"), new ArrayList(Arrays.asList(6.56d,16.0d)), new ArrayList()));
        expResult.setDataArray(array);
    ...
    public void getObservationsTest() throws Exception {
        ...
        Assert.assertEquals(261, result.getValue().size());

        final Set<String> resultIds = new HashSet<>();
        result.getValue().stream().forEach(ds -> resultIds.add(ds.getIotId()));
        Assert.assertEquals(261, resultIds.size());
    ...
    public void getObservedPropertyByIdTest() throws Exception {
        ...
        Assert.assertEquals(8, result.getDatastreams().size());
        ...
        Assert.assertEquals(8, result.getMultiDatastreams().size());
       ...
       resultIds.clear();
       Assert.assertEquals(8, dsResponse.getValue().size());
       ...
       Assert.assertEquals(8, mdsResponse.getValue().size());
    ...
    public void getObservedPropertiesTest() throws Exception {
        ...
        Assert.assertEquals(7, result.getValue().size());
        Set<String> resultIds = new HashSet<>();
        result.getValue().stream().forEach(ds -> resultIds.add(ds.getIotId()));

        Assert.assertEquals(7, resultIds.size());
    ...
    public void getDatastreamTest() throws Exception {
        ...
        Assert.assertEquals(34, result.getValue().size());

        Set<String> resultIds = new HashSet<>();
        result.getValue().stream().forEach(ds -> resultIds.add(ds.getIotId()));

        Assert.assertEquals(34, resultIds.size());
    ...
    public void getMultiDatastreamTest() throws Exception {
        ...
        Assert.assertEquals(16, result.getValue().size());

        Set<String> resultIds = new HashSet<>();
        result.getValue().stream().forEach(ds -> resultIds.add(ds.getIotId()));

        Assert.assertEquals(16, resultIds.size());
