...
public class OM2STSWorkerTest extends SpringContextTest {
    ...
    public void getFeatureOfInterestByIdTest() throws Exception {
        ...
        Assert.assertEquals(55, result.getObservations().size());
        ...
        */
        ...
        Assert.assertEquals(55, obsResult.getValue().size());
    ...
    public void getObservationsDataStreamDataArrayTest() throws Exception {
        ...
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-1", "2007-05-01T10:59:00Z", "2007-05-01T10:59:00Z", 6.56, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-2", "2007-05-01T11:59:00Z", "2007-05-01T11:59:00Z", 6.56, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-3", "2007-05-01T12:59:00Z", "2007-05-01T12:59:00Z", 6.56, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-4", "2007-05-01T13:59:00Z", "2007-05-01T13:59:00Z", 6.56, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:507-2-5", "2007-05-01T14:59:00Z", "2007-05-01T14:59:00Z", 6.56, new ArrayList<>()));
        ...
        expResult.setComponents(Arrays.asList("id", "phenomenonTime", "resultTime", "result", "resultQuality"));
        array = new ArrayList<>();
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-1", "2000-11-30T23:00:00Z", "2000-11-30T23:00:00Z", 2.5, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-2", "2009-12-01T13:00:00Z", "2009-12-01T13:00:00Z", 5.9, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-3", "2009-12-11T13:01:00Z", "2009-12-11T13:01:00Z", 8.9, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-4", "2009-12-15T13:02:00Z", "2009-12-15T13:02:00Z", 7.8, new ArrayList<>()));
        array.add(Arrays.asList("urn:ogc:object:observation:GEOM:3000-2-5", "2012-12-21T23:00:00Z", "2012-12-21T23:00:00Z", 9.9, new ArrayList<>()));
        expResult.setDataArray(array);
    ...
    public void getObservationsDataStreamDataArrayDecimTest() throws Exception {
        ...
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-1", ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T11:59:00.0"), 6.56));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-2", ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T12:59:00.0"), 6.56));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-3", ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T13:59:00.0"), 6.56));
        array.add(Arrays.asList("urn:ogc:object:sensor:GEOM:test-1-dec-4", ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0"), ISO_8601_3_FORMATTER.parse("2007-05-01T14:59:00.0"), 6.56));
        expResult.setDataArray(array);
    ...
    public void getObservationsTest() throws Exception {
        ...
        Assert.assertEquals(193, result.getValue().size());

        final Set<String> resultIds = new HashSet<>();
        result.getValue().stream().forEach(ds -> resultIds.add(ds.getIotId()));
        Assert.assertEquals(193, resultIds.size());
    ...
    public void getDatastreamTest() throws Exception {
        ...
        Assert.assertEquals(26, result.getValue().size());

        Set<String> resultIds = new HashSet<>();
        result.getValue().stream().forEach(ds -> resultIds.add(ds.getIotId()));

        Assert.assertEquals(26, resultIds.size());
    ...
    public void getMultiDatastreamTest() throws Exception {
        ...
        Assert.assertEquals(14, resultIds.size());
