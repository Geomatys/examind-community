...
public class WMSPortrayal {
    ...
    @XmlTransient
    private final static Map<String,ImageWriterSpi> nativewriterspi = new HashMap<>();
    ...
    private List<String> nativeReader = new ArrayList<>();
    ...
    private List<String> nativeWriter = new ArrayList<>();
    ...
    public Map<String,Float> getCompressions(){
        final Map<String, Float> compMap = new HashMap<>();
