...
/**
 * Process descriptor for loading STAC in OpenEO.
 * cf. <a href="https://open-eo.github.io/openeo-python-client/api.html#openeo.rest.connection.Connection.load_stac">load_stac</a>
 *
...
public class LoadStacDescriptor extends AbstractCstlProcessDescriptor {
    ...
    public static final String STAC_URL_NAME = "url";
    private static final String STAC_URL_REMARKS = "The STAC URL to a STAC collection or item.";
    public static final ParameterDescriptor<String> STAC_URL = BUILDER
...
//                "Also supports open intervals by setting one of the boundaries to `null`, but never both.\n\n" +
    ...
    public static final ParameterDescriptorGroup INPUT_DESC = BUILDER.addName("InputParameters").setRequired(true)
            .createGroup(STAC_URL, EXTERNAL_STAC_CUSTOM_PROCESS, SPATIAL_EXTENT, TEMPORAL_EXTENT, BANDS, PROPERTIES);
    ...
    private static final String OUTPUT_REMARKS = "A GridCoverage containing the data of the loaded collection. " +
            "This objct is a data cube that will be use for further processing.";
    ...
    /**
     * Public constructor uses by the ServiceRegistry to find and instantiate all ProcessDescriptor.
     */
    public LoadStacDescriptor() {
        super(NAME, ExamindProcessFactory.IDENTIFICATION, ABSTRACT, INPUT_DESC, OUTPUT_DESC);
    }

    public static final ProcessDescriptor INSTANCE = new LoadStacDescriptor();
