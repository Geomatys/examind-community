 ...
 */
public class GeneralParameterValueConverter implements HttpMessageConverter<GeneralParameterValue> {
    ...
    @Override
    public void write(GeneralParameterValue t, MediaType mt, HttpOutputMessage hom) throws IOException, HttpMessageNotWritableException {
        try {
